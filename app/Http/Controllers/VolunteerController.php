...
class VolunteerController extends Controller
{
    ...
    public function full($id)
    {
        ...
        return view('interactions.display',['volunteer'=>$volunteer[0],
    ...
    public function create()
    {
        ...
        $Volunteer = Volunteer::create(["first_name"=>$user[0]->first_name,"last_name"=>$user[0]->last_name,
        ...
        //dd($Volunteer);
        Volunteer_does_donation::create(["volunteer_id"=>$Volunteer->id,"campaign_id"=>1,
        "donations_amount"=> $user[0]->donations_amount]);
        Volunteer_act_campaign::create(["volunteer_id"=>$Volunteer->id,"campaign_id"=>1,
        "info"=> 1,"soutien"=> 0]);
        Volunteer_sign_call::create(["volunteer_id"=>$Volunteer->id,"call_id"=>1,
        "question"=> 'la vie la mort Zihuatanejo']);
        Volunteer_use_canal::create(["volunteer_id"=>$Volunteer->id,"canal_id"=>1,
        "entry_way"=> $user[0]->wa_enter_way]);
        Volunteer_use_group::create(["volunteer_id"=>$Volunteer->id,"groups_id"=>1]);
        Email::insert(["volunteer_id"=>$Volunteer->id,"opt_in"=>1,
        "email"=> $user[0]->email]);
        Phone::insert(["volunteer_id"=>$Volunteer->id,"opt_in"=>1,
        ...
        $Volunteer2 = Volunteer::create(["first_name"=>$user2[0]->first_name,"last_name"=>$user2[0]->last_name,
        ...
        "organizer_id"=>1, "volunteer_scale"=>1 ]);
        //dd($Volunteer);
        Volunteer_does_donation::create(["volunteer_id"=>$Volunteer2->id,"campaign_id"=>1,
        "donations_amount"=> $user2[0]->donations_amount/2]);
        Volunteer_does_donation::create(["volunteer_id"=>$Volunteer2->id,"campaign_id"=>1,
        "donations_amount"=> $user2[0]->donations_amount/2]);
        Volunteer_act_campaign::create(["volunteer_id"=>$Volunteer2->id,"campaign_id"=>1,
        "info"=> 1,"soutien"=> 1]);
        Volunteer_sign_call::create(["volunteer_id"=>$Volunteer2->id,"call_id"=>1,
        "question"=> 'es-ce qu\'être gaucher, fait de moi quelqu\'un de gauche']);
        Volunteer_use_canal::create(["volunteer_id"=>$Volunteer2->id,"canal_id"=>1,
        "entry_way"=> $user2[0]->wa_enter_way]);
        Volunteer_use_group::create(["volunteer_id"=>$Volunteer2->id,"groups_id"=>1]);
        Email::insert(["volunteer_id"=>$Volunteer2->id,"opt_in"=>0,
        "email"=> $user2[0]->email]);
        Email::insert(["volunteer_id"=>$Volunteer2->id,"opt_in"=>1,
        "email"=> 'Copertino@legoat.com']);
        Phone::insert(["volunteer_id"=>$Volunteer2->id,"opt_in"=>0,
